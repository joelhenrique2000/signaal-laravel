...
class RadioGroup {
  ...
  setChecked(currentItem) {
    ...
    console.log(currentItem.getAttribute("data-value"))
    console.log(document.getElementsByName("respostaId").value)
    document.getElementsByName("respostaId").value = currentItem.getAttribute("data-value")
  }
